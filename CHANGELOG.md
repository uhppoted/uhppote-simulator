...
### Changed
1. Fixed initialisation of EventList when unmarshalling from JSON (cf. https://github.com/uhppoted/uhppote-simulator/issues/6)
2. Reworked checkTimeProfile to include the controller time offset (cf. https://github.com/uhppoted/uhppote-simulator/issues/5)
